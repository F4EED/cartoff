#!/usr/bin/env python3
"""Exporte les héliports (aeroway=heliport) du département 42 depuis OSM."""
...
OUTPUT = Path(__file__).resolve().parent.parent / "geojson" / "D42" / "heliports_osm_42.geojson"

QUERY = """
[out:json][timeout:120];
area["ISO3166-2"="FR-42"]->.searchArea;
(
  nwr["aeroway"="heliport"](area.searchArea);
);
out center tags;
"""
